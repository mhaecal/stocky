...
var _yield$_this7$stripe$,token,error;

return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2){
while(1){
switch(_context2.prev=_context2.next){
case 0:
_this7.paymentProcessing=true;
_context2.next=3;
return _this7.stripe.createToken(_this7.cardElement);

case 3:
_yield$_this7$stripe$=_context2.sent;
token=_yield$_this7$stripe$.token;
error=_yield$_this7$stripe$.error;

if(error){
_this7.paymentProcessing=false;
nprogress__WEBPACK_IMPORTED_MODULE_2___default.a.done();

_this7.makeToast("danger",_this7.$t("InvalidData"),_this7.$t("Failed"));
}else {
axios.post("sales",{
date:_this7.sale.date,
client_id:_this7.sale.client_id,
warehouse_id:_this7.sale.warehouse_id,
statut:_this7.sale.statut,
notes:_this7.sale.notes,
tax_rate:_this7.sale.tax_rate,
TaxNet:_this7.sale.TaxNet,
discount:_this7.sale.discount,
shipping:_this7.sale.shipping,
GrandTotal:_this7.GrandTotal,
details:_this7.details,
payment:_this7.payment,
change:parseFloat(_this7.payment.received_amount-_this7.payment.amount).toFixed(2),
token:token.id}).
